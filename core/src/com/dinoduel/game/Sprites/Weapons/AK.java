...
public class AK extends Gun {
    public AK(float x, float y, World world, PlayScreen screen) {
        ...
        img = new TextureRegion(getTexture(), 0, 200, xSize, ySize);
        ...
        for (int i = 1; i < 4; i++) {
            frames.add(new TextureRegion(getTexture(), i * xSize, 200, xSize, ySize));
        }
        frames.add(new TextureRegion(getTexture(), 2 * xSize, 200, xSize, ySize));
